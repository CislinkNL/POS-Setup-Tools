...
- [`Kiosk_Mode_Guide.md`](./docs/Kiosk_Mode_Guide.md) - 🔒 **Kiosk Mode 完全指南**
  - 四种锁定方案对比
  - Shell Launcher 配置（推荐）
  - 密码保护和解锁方法
  - 安全最佳实践
  - 故障排除和恢复方案
...
- [`System_Compatibility.md`](./docs/System_Compatibility.md) - 🖥️ **系统兼容性详细说明**
  - Windows 10/11 所有版本支持状态
  - Home/Pro/Enterprise 版本差异
  - Server 版本兼容性
  - 功能矩阵对照表
